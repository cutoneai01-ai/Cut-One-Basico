 ...
 * transaccional de antes del 2026-09-23 (CA-02), y que ninguna cadena del preset resultante contenga
 * una referencia sin resolver a esas dos paletas.
 */
describe('buildPreset — preset barberia (M-20 RN-CFG-63, RN-CFG-64)', () => {
  it('semantic.primary.400 es el oro antiguo del correo de antes de RF-TC01, #d4af37', () => {
  ...
  it('semantic.surface.950 es el ébano del correo de antes de RF-TC01, #0a0a0a', () => {
    const preset = buildPreset(THEMES.barberia);
